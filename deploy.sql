...
-- Allow SYSADMIN to manage integrations and network rules (needed by the app to add new instances)
GRANT CREATE INTEGRATION ON ACCOUNT TO ROLE SYSADMIN;
GRANT CREATE NETWORK RULE ON SCHEMA PGSYNC_DB.METADATA TO ROLE SYSADMIN;
